...
function StatCard({ icon, number, description, isHighlighted = false }) {
  const baseClasses =
    "flex overflow-hidden flex-col justify-center px-12 py-8 rounded min-w-[240px] w-[270px] max-md:px-5";
  const highlightedClasses = "text-white bg-red-500 shadow-sm";
  const normalClasses =
    "text-black border border-solid border-black border-opacity-30";
